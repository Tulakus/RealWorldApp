...
export class ArticleMeta extends React.Component<IProps> {
    ...
    render() {
        const favoriteAction = this.props.favorited ? this.unfavorite : this.favorite;
        ...
        return <div className="article-meta">
            ...
            <div className="info">
                <a href="" className="author">{this.props.userName}</a>
                <span className="date">{this.props.date}</span>
            </div>
            <button className="btn btn-sm btn-outline-secondary" onClick={e => followAction(this.props.slug)}>
                <i className="ion-plus-round"></i>
                &nbsp; Follow {this.props.userName}
                <span className="counter">({!!this.props.following && this.props.following || 0})</span>
            </button>

            &nbsp;&nbsp;

            <button className="btn btn-sm btn-outline-primary" onClick={e => favoriteAction(this.props.userName)} >
                <i className="ion-heart"></i>
                &nbsp;
                Favorite Post
                <span className="counter">({!!this.props.favoriteCount && this.props.favoriteCount || 0})</span>
            </button>
        </div>
    }
}